...
const errors = []
if (pkg.name !== 'dsh-hanshuang') errors.push('package.json name does not match scaffold name')
...
if (!patch || !patch.includes('- insert:') || !patch.includes('dsh-hanshuang')) errors.push('cordis.patch.yml must insert the package name')
