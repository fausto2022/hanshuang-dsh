...
var name = "dsh-hanshuang";
var inject = ["systemPrompt"];
var PLUGIN_ID = "dsh-hanshuang";
var SECTION_NAME = "hanshuang-system-spec";
var SECTION_ORDER = -100;
var API_PREFIX = "/dsh-hanshuang";
var MAX_PROMPT_CHARS = 512 * 1024;
var DEFAULT_ACTIVATION_WORD = "\u5BD2\u971C";
var DEFAULT_ACTIVATION_REPLY = "\u5DF2\u6210\u529F";
var CONFIG_DIR = join(homedir(), ".dsh");
var CONFIG_FILE = join(CONFIG_DIR, "hanshuang.json");
var VARIANT_FILES = {
  v3: "hanshuang-v3.md",
...
var FALLBACK_PROMPT = `## \u5BD2\u971C\u5DE5\u4F5C\u89C4\u8303 (\u5185\u5D4C\u7CBE\u7B80\u7248)
...
function hanshuangCommandHandler(ctx, refresh) {
  return async (args) => {
...
\u914D\u7F6E\u6587\u4EF6\uFF1A${CONFIG_FILE}`;
    ...
    if (args.set) {
      ...
      refresh();
      return id === DEFAULT_ID ? `\u5DF2\u6062\u590D DSH \u9ED8\u8BA4\u7CFB\u7EDF\u63D0\u793A\u8BCD\uFF0C\u5BD2\u971C\u4E0D\u518D\u6CE8\u5165\u3002
