window.__ModuleLoader__.load({ id: "dsh-hanshuang", factory: (require) => {
...
var API = "/dsh-hanshuang";
var TAG_ID = "dsh-hanshuang/HanshuangSettings.module.css";
var CSS = `
...
function HanshuangSettings() {
  ...
  const [wordDraft, setWordDraft] = (0, import_react.useState)("\u5BD2\u971C");
  ...
  if (!state) {
    return import_react.default.createElement(
      "div",
      { className: "hs-root" },
      import_react.default.createElement("p", { className: "hs-status" }, busy ? "\u6B63\u5728\u8BFB\u53D6\u5BD2\u971C\u914D\u7F6E\u2026" : notice?.text ?? "\u672A\u80FD\u8BFB\u53D6\u914D\u7F6E"),
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement(
      "header",
      { className: "hs-head" },
      import_react.default.createElement("div", { className: "hs-kicker" }, "HANSHUANG"),
      import_react.default.createElement("h2", { className: "hs-title" }, "\u5BD2\u971C\u63D0\u793A\u8BCD"),
      import_react.default.createElement("p", { className: "hs-lead" }, "\u9009\u62E9\u6CE8\u5165 Agent \u7684\u7CFB\u7EDF\u63D0\u793A\u8BCD\u3002\u4E0D\u60F3\u7528\u65F6\u6062\u590D DSH \u9ED8\u8BA4\uFF0C\u540E\u7EED\u5BF9\u8BDD\u7ACB\u5373\u4E0D\u518D\u6CE8\u5165\u5BD2\u971C\u3002"),
    ...
    import_react.default.createElement(
      ...
      import_react.default.createElement(
        ...
        import_react.default.createElement("div", { className: "hs-switchTitle" }, state.enabled ? "\u5BD2\u971C\u6CE8\u5165\u5DF2\u5F00\u542F" : "\u5DF2\u6062\u590D DSH \u9ED8\u8BA4"),
        import_react.default.createElement("div", { className: "hs-switchMeta" }, state.enabled ? "\u5F53\u524D\u4F1A\u628A\u9009\u4E2D\u7684\u63D0\u793A\u8BCD\u6CE8\u5165\u7CFB\u7EDF\u63D0\u793A\u3002\u5173\u95ED\u540E\u7ACB\u5373\u56DE\u5230 Harness \u539F\u63D0\u793A\u8BCD\uFF0C\u5DF2\u4FDD\u5B58\u7684\u5957\u4ECD\u4FDD\u7559\u3002" : "\u5BD2\u971C\u4E0D\u518D\u6CE8\u5165\u3002\u91CD\u65B0\u6253\u5F00\u5F00\u5173\uFF0C\u6216\u542F\u7528\u4EFB\u4E00\u5185\u7F6E/\u81EA\u5B9A\u4E49\u5957\u5373\u53EF\u6062\u590D\u3002")
      ),
    ...
    import_react.default.createElement(
      ...
      import_react.default.createElement("div", { className: "hs-latchPreview" }, state.enabled ? `\u7528\u6237\u8BF4\u300C${state.activationWord || "\u5BD2\u971C"}\u300D\u2192 ${state.activationPreview || `${state.activationReply || "\u5DF2\u6210\u529F"} \xB7 ${state.activeId}`}` : "\u5F53\u524D\u672A\u6CE8\u5165\uFF0C\u542C\u8BCD\u4E0D\u4F1A\u89E6\u53D1\u3002"),
      import_react.default.createElement(
        "div",
    ...
    state.envPath && state.enabled ? import_react.default.createElement("div", { className: "hs-banner" }, "\u68C0\u6D4B\u5230 HANSHUANG_PROMPT_PATH\uFF0C\u5F53\u524D\u5B9E\u9645\u6CE8\u5165\u6765\u81EA\u8BE5\u6587\u4EF6\u3002\u5173\u95ED\u6CE8\u5165\u6216\u6E05\u9664\u8BE5\u73AF\u5883\u53D8\u91CF\u540E\u624D\u4F1A\u6539\u7528\u8BBE\u7F6E\u9875\u9009\u62E9\u3002") : null,
    import_react.default.createElement(
      "ul",
      { className: "hs-grid" },
    ...
    selected ? import_react.default.createElement(
      "section",
      { className: "hs-editor" },
      import_react.default.createElement("div", { className: "hs-label" }, selected.kind === "default" ? "DSH \u9ED8\u8BA4\uFF08\u4E0D\u6CE8\u5165\u5BD2\u971C\uFF09" : readOnly ? "\u73AF\u5883\u53D8\u91CF\u63D0\u793A\u8BCD\uFF08\u53EA\u8BFB\uFF09" : "\u7F16\u8F91\u5F53\u524D\u63D0\u793A\u8BCD"),
      ...
      selected.kind === "default" ? import_react.default.createElement("div", { className: "hs-banner" }, "\u4E0D\u4F1A\u5199\u5165\u5BD2\u971C\u6BB5\u843D\u3002Agent \u53EA\u4F7F\u7528 DeepSeek Harness \u81EA\u5E26\u7684\u7CFB\u7EDF\u63D0\u793A\u8BCD\u3002\u5DF2\u4FDD\u5B58\u7684\u5185\u7F6E\u6539\u5199\u548C\u81EA\u5B9A\u4E49\u5957\u90FD\u8FD8\u5728\uFF0C\u968F\u65F6\u53EF\u4EE5\u518D\u542F\u7528\u3002") : import_react.default.createElement("textarea", {
        className: "hs-area",
        value: draft,
        spellCheck: false,
        readOnly,
      ...
      import_react.default.createElement(
        ...
        import_react.default.createElement("button", {
          ...
          }), selected.kind === "default" ? "\u5DF2\u6062\u590D DSH \u9ED8\u8BA4\u7CFB\u7EDF\u63D0\u793A\u8BCD\uFF0C\u5BD2\u971C\u4E0D\u518D\u6CE8\u5165\u3002" : `\u5DF2\u542F\u7528\u300C${selected.name}\u300D\uFF0C\u540E\u7EED\u5BF9\u8BDD\u7ACB\u5373\u751F\u6548\u3002`, selected.id)
